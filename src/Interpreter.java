...
public class Interpreter {
    public static void main(String args[])
    {
        ...
        try {
            ...
            PrgState prg1 = new PrgState(new MyExeStack(), new MySymTbl(), new MyDictionary<>(), new MyList<>(),new Heap<>(), ex1);
        ...
        try
        {
            ...
            PrgState prg5=new PrgState(new MyExeStack(),new MySymTbl(),new MyDictionary<>(),new MyList<>(),new Heap<>(),ex5);
        ...
        try
        {
            ...
            PrgState prg2=new PrgState(new MyExeStack(),new MySymTbl(),new MyDictionary<>(),new MyList<>(),new Heap<>(),ex2);
        ...
        try
        {
            ...
            PrgState prg3=new PrgState(new MyExeStack(),new MySymTbl(),new MyDictionary<>(),new MyList<>(),new Heap<>(),ex3);
        ...
        try
        {
            ...
            PrgState prg6=new PrgState(new MyExeStack(),new MySymTbl(),new MyDictionary<>(),new MyList<>(),new Heap<>(),ex6);
        ...
        try {
            ...
            PrgState prg8 = new PrgState(new MyExeStack(), new MySymTbl(), new MyDictionary<>(), new MyList<>(), new Heap<>(), ex8);
        ...
        try
        {
            ...
            PrgState prg7 = new PrgState(new MyExeStack(), new MySymTbl(), new MyDictionary<>(), new MyList<>(), new Heap<>(), ex7);
        ...
        try
        {
            ...
            PrgState prg9 = new PrgState(new MyExeStack(), new MySymTbl(), new MyDictionary<>(), new MyList<>(), new Heap<>(), ex9);
        ...
        try
        {
            ...
            PrgState prg9 = new PrgState(new MyExeStack(), new MySymTbl(), new MyDictionary<>(), new MyList<>(), new Heap<>(), ex10);
        ...
        try
        {
            ...
            PrgState prg9 = new PrgState(new MyExeStack(), new MySymTbl(), new MyDictionary<>(), new MyList<>(), new Heap<>(), ex11);
